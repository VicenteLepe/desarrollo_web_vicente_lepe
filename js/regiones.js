...
regiones_comunas = {
    ...
    "Antofagasta": ["Antofagasta", "Mejillones", "Sierra Gorda", "Taltal", "Calama", "Ollagüe", "San Pedro de Atacama", "María Elena", "Tocopilla", "Chañaral", "Diego de Almagro"],
    ...
    "Maule": ["Talca", "ConsVitacura", "Curepto", "Empedrado", "Maule", "Pelarco", "Pencahue", "Río Claro", "San Clemente", "San Rafael", "Cauquenes", "Chanco", "Pelluhue", "Curicó", "Hualañé", "Licantén", "Molina", "Rauco", "Romeral", "Sagrada Familia", "Teno", "Vichuquén", "Linares", "Colbún", "Longaví", "Parral", "Retiro", "San Javier", "Villa Alegre", "Yerbas Buenas"],
    ...
    "Aysén del Gral.Ibañez del Campo": ["Coihaique", "Lago Verde", "Aisén", "Cisnes", "Guaitecas", "Cochrane", "O'Higgins", "Tortel", "Chile Chico", "Río Ibáñez"],
...
const cambiarComunas = () => {
    let selectedRegion = document.getElementById("region").value

    if (!selectedRegion) {
        comunaInput.style.display = "none"
    } else {
        comunaInput.style.display = "block"

        const comunas = document.getElementById("comuna")
        const options = comunas.querySelectorAll("option")
        ...
        comunas.appendChild(defaultOption)
    
        for (let i=0; i<regiones_comunas[selectedRegion].length; i++) {
            let option = document.createElement("option")
            option.value = regiones_comunas[selectedRegion][i]
            option.text = regiones_comunas[selectedRegion][i]
...
regiones.addEventListener("change", cambiarComunas)